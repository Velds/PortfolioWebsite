            ...
            <div className="profile-root w-full flex">    
                <div className="profile-details-name flex flex-col w-1/2 pl-24 mt-10">
                    ...
                    <div className="introduction text-left mt-5">
                        Welcome to Nicholas' online portfolio. I am a soon to be graduate and is proficient in Full-stack development 
                    </div>
                    ...
                    <div className="showMore mt-8 text-left">
                        <a href="#" className="border-2 px-2 py-2 border-black hover:border-gray-600 rounded">
                            Show More
                        </a>
                    </div>
                </div>
